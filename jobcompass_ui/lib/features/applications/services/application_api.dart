...
class ApplicationApi {
  ...
  Future<List<Application>> fetchArchivedApplications() async {
    final response = await dio.get('/applications/archived');
  ...
  Future<Application> archiveApplication(int applicationId) async {
    final response = await dio.patch('/applications/$applicationId/archive');
  ...
  Future<Application> unarchiveApplication(int applicationId) async {
    final response = await dio.patch('/applications/$applicationId/unarchive');
  ...
  Future<void> recordApplyInteraction(Job job) async {
    await dio.post(
      '/jobs/interact',
      data: job.toInteractionJson(action: 'apply'),
    );
  }
}
